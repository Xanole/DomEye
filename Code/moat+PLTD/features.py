...
if __name__ == '__main__':
    ...
    # for training
    # pcap_archive = 'Desktop\\data\\dataset\\train\\moat'
    # csv_path = 'Desktop\\data\\dataset\\train\\domain_train_moat+PLTD.csv'
    # extract2csv(pcap_archive, csv_path)

    # pcap_archive = 'Desktop\\data\\dataset\\train\\normal'
    # csv_path = 'Desktop\\data\\dataset\\train\\normal_train_moat+PLTD.csv'
    # extract2csv(pcap_archive, csv_path)

    # for tpr testing
    # pcap_archive = 'Desktop\\data\\dataset\\test_tpr\\moat'
    ...
    for archive in os.listdir(pcap_archive):
        ...
        csv_path = 'Desktop\\data\\dataset\\test_fpr\\moat+PLTD\\' + archive + '.csv'
