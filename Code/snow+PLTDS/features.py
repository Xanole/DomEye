...
if __name__ == '__main__':
    ...
    # for training
    # pcap_archive = 'Desktop\\data\\dataset\\train\\snowflake'
    # csv_path = 'Desktop\\data\\dataset\\train\\domain_train_snow+PLTDS.csv'
    ...
    # for tpr testing
    # pcap_archive = 'Desktop\\data\\dataset\\test_tpr\\snowflake'
    # csv_path = 'Desktop\\data\\dataset\\test_tpr\\test_snow+PLTDS.csv'
    # extract2csv(pcap_archive, csv_path)
    ...
    for archive in os.listdir(pcap_archive):
        ...
        csv_path = 'Desktop\\data\\dataset\\test_fpr\\snow+PLTDS\\' + archive + '.csv'
